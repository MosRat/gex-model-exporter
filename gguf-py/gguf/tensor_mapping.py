...
class TensorNameMap:
    mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.TOKEN_EMBD: (
            ...
            "decoder.transformer.wte",  # gpt2_dec
        ),
        ...
        MODEL_TENSOR.POS_EMBD: (
            ...
            "wpe",  # gpt2
            "decoder.transformer.wpe",  # gpt2_dec
        ),
        # Output
        MODEL_TENSOR.OUTPUT: (
            "embed_out",  # gptneox
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.DEC_ATTN_NORM: (
            ...
            "decoder.transformer.h.{bid}.ln_1",  # gpt2
        ),
        MODEL_TENSOR.DEC_ATTN_Q: (
            "decoder.block.{bid}.layer.0.SelfAttention.q",  # t5
            "decoder.transformer.h.{bid}.attn.q",  # gpt2
        ),
        MODEL_TENSOR.DEC_ATTN_K: (
            "decoder.block.{bid}.layer.0.SelfAttention.k",  # t5
            "decoder.transformer.h.{bid}.attn.k",  # gpt2
        ),
        MODEL_TENSOR.DEC_ATTN_V: (
            "decoder.block.{bid}.layer.0.SelfAttention.v",  # t5
            "decoder.transformer.h.{bid}.attn.v",  # gpt2
        ),
        MODEL_TENSOR.DEC_ATTN_OUT: (
            "decoder.block.{bid}.layer.0.SelfAttention.o",  # t5
            "decoder.transformer.h.{bid}.attn.c_proj",  # gpt2
        ),
        ...
        MODEL_TENSOR.DEC_CROSS_ATTN_NORM: (
            ...
            "decoder.transformer.h.{bid}.ln_cross_attn",  # gpt2
        ),
        MODEL_TENSOR.DEC_CROSS_ATTN_Q: (
            "decoder.block.{bid}.layer.1.EncDecAttention.q",  #
            "decoder.transformer.h.{bid}.crossattention.q",  # gpt2
        ),
        MODEL_TENSOR.DEC_CROSS_ATTN_K: (
            "decoder.block.{bid}.layer.1.EncDecAttention.k",  # t5
            "decoder.transformer.h.{bid}.crossattention.k",  # gpt2
        ),
        MODEL_TENSOR.DEC_CROSS_ATTN_V: (
            "decoder.block.{bid}.layer.1.EncDecAttention.v",  # t5
            "decoder.transformer.h.{bid}.crossattention.v",  # gpt2
        ),
        MODEL_TENSOR.DEC_CROSS_ATTN_OUT: (
            "decoder.block.{bid}.layer.1.EncDecAttention.o",  # t5
            "decoder.transformer.h.{bid}.crossattention.c_proj",  # gpt2
        ),
        ...
        MODEL_TENSOR.DEC_FFN_NORM: (
            ...
            "decoder.transformer.h.{bid}.ln_2",  # gpt2
        ),
        ...
        MODEL_TENSOR.DEC_FFN_UP: (
            ...
            "decoder.transformer.h.{bid}.mlp.c_fc",  # gpt2
        ),
        MODEL_TENSOR.DEC_FFN_DOWN: (
            "decoder.block.{bid}.layer.2.DenseReluDense.wo",  # t5
            "decoder.transformer.h.{bid}.mlp.c_proj",  # gpt2
        ),
        MODEL_TENSOR.DEC_OUTPUT_NORM: (
            "decoder.final_layer_norm",  # t5
            "decoder.transformer.ln_f",  # gpt2
        ),
        ...
        MODEL_TENSOR.V_ENC_ATTN_O: (
            ...
            # "vit.blocks.{bid}.attn.proj",  # gext
            # "model.vit.blocks.{bid}.attn.proj",  # gext
        ),
        MODEL_TENSOR.V_ENC_ATTN_RPOS_H: ("visual.blocks.{bid}.attn.rel_pos_h.weight",),
        MODEL_TENSOR.V_ENC_ATTN_RPOS_W: ("visual.blocks.{bid}.attn.rel_pos_w.weight",),
        ...
        MODEL_TENSOR.V_ENC_FFN_UP: (
            ...
            "visual.blocks.{bid}.mlp.lin1",  # gext
        ),
        ...
        MODEL_TENSOR.V_ENC_FFN_DOWN: (
            ...
            "visual.blocks.{bid}.mlp.lin2",  # gext
        ),
        ...
        MODEL_TENSOR.V_NECK_CONV_1: ("visual.neck.0",),
        MODEL_TENSOR.V_NECK_NORM_1: ("visual.neck.1",),
        MODEL_TENSOR.V_NECK_CONV_2: ("visual.neck.2",),
        MODEL_TENSOR.V_NECK_NORM_2: ("visual.neck.3",),
        MODEL_TENSOR.V_NECK_CONV_3: ("visual.net_2",),
        MODEL_TENSOR.V_NECK_CONV_4: ("visual.net_3",),
        MODEL_TENSOR.V_PROJ_LIN: ("visual_proj",),
