    ...
    def find_hparam(self, keys: Iterable[str], optional: bool = False) -> Any:
        key = next(
            (
                k
                for k in keys
                if (k in self.hparams or k in self.hparams.get("decoder", []))
            ),
            None,
        )
        if key is not None:
            return self.hparams.get(key, self.hparams.get("decoder", {}).get(key,None))
        if optional:
            return None
...
class TextModel(ModelBase):
    ...
    def set_gguf_parameters(self):
        ...
        if (
            n_ctx := self.find_hparam(
                ["max_position_embeddings", "n_ctx", "n_positions"], optional=True
            )
        ) is not None:
    ...
    def get_vocab_base_pre(self, tokenizer) -> str:
        ...
        if chkhsh == "0ef9807a4087ebef797fc749390439009c3b9eda9ad1a097abbe738f486c01e5":
            # ref: https://hf-mirror.com/meta-llama/Meta-Llama-3-8B
            res = "llama-bpe"
        if chkhsh == "049ecf7629871e3041641907f3de7c733e4dbfdc736f57d882ba0b0845599754":
            # ref: https://hf-mirror.com/deepseek-ai/deepseek-llm-7b-base
            res = "deepseek-llm"
        if chkhsh == "347715f544604f9118bb75ed199f68779f423cabb20db6de6f31b908d04d7821":
            # ref: https://hf-mirror.com/deepseek-ai/deepseek-coder-6.7b-base
            res = "deepseek-coder"
        if chkhsh == "8aeee3860c56296a157a1fe2fad249ec40aa59b1bb5709f4ade11c4e6fe652ed":
            # ref: https://hf-mirror.com/tiiuae/falcon-7b
            res = "falcon"
        if chkhsh == "0876d13b50744004aa9aeae05e7b0647eac9d801b5ba4668afc01e709c15e19f":
            # ref: https://hf-mirror.com/BAAI/bge-small-en-v1.5
            res = "bert-bge"
        if chkhsh == "9d032fcbd5501f4a38150912590928bfb36091efb5df11b8e2124b0390e3fb1e":
            # ref: https://hf-mirror.com/tiiuae/Falcon3-7B-Base
            res = "falcon3"
        if chkhsh == "8e62295832751ca1e8f92f2226f403dea30dc5165e448b5bfa05af5340c64ec7":
            # ref: https://hf-mirror.com/BAAI/bge-large-zh-v1.5
            res = "bert-bge-large"
        if chkhsh == "b6dc8df998e1cfbdc4eac8243701a65afe638679230920b50d6f17d81c098166":
            # ref: https://hf-mirror.com/mosaicml/mpt-7b
            res = "mpt"
        if chkhsh == "35d91631860c815f952d711435f48d356ebac988362536bed955d43bfa436e34":
            # ref: https://hf-mirror.com/bigcode/starcoder2-3b
            res = "starcoder"
        if chkhsh == "3ce83efda5659b07b1ad37ca97ca5797ea4285d9b9ab0dc679e4a720c9da7454":
            # ref: https://hf-mirror.com/openai-community/gpt2
            res = "gpt-2"
        if chkhsh == "32d85c31273f8019248f2559fed492d929ea28b17e51d81d3bb36fff23ca72b3":
            # ref: https://hf-mirror.com/stabilityai/stablelm-2-zephyr-1_6b
            res = "stablelm2"
        if chkhsh == "6221ad2852e85ce96f791f476e0b390cf9b474c9e3d1362f53a24a06dc8220ff":
            # ref: https://hf-mirror.com/smallcloudai/Refact-1_6-base
            res = "refact"
        if chkhsh == "e636dc30a262dcc0d8c323492e32ae2b70728f4df7dfe9737d9f920a282b8aea":
            # ref: https://hf-mirror.com/Qwen/Qwen1.5-7B
            res = "qwen2"
        if chkhsh == "b6dc8df998e1cfbdc4eac8243701a65afe638679230920b50d6f17d81c098166":
            # ref: https://hf-mirror.com/allenai/OLMo-1.7-7B-hf
            res = "olmo"
        if chkhsh == "c7699093ba4255a91e702aa38a596aa81669f3525dae06c2953267dde580f448":
            # ref: https://hf-mirror.com/jinaai/jina-reranker-v1-tiny-en
            res = "jina-v1-en"
        if chkhsh == "0876d13b50744004aa9aeae05e7b0647eac9d801b5ba4668afc01e709c15e19f":
            # ref: https://hf-mirror.com/jinaai/jina-embeddings-v2-base-en
            res = "jina-v2-en"
        if chkhsh == "171aeeedd6fb548d418a7461d053f11b6f1f1fc9b387bd66640d28a4b9f5c643":
            # ref: https://hf-mirror.com/jinaai/jina-embeddings-v2-base-es
            res = "jina-v2-es"
        if chkhsh == "27949a2493fc4a9f53f5b9b029c82689cfbe5d3a1929bb25e043089e28466de6":
            # ref: https://hf-mirror.com/jinaai/jina-embeddings-v2-base-de
            res = "jina-v2-de"
        if chkhsh == "c136ed14d01c2745d4f60a9596ae66800e2b61fa45643e72436041855ad4089d":
            # ref: https://hf-mirror.com/abacusai/Smaug-Llama-3-70B-Instruct
            res = "smaug-bpe"
        if chkhsh == "c7ea5862a53e4272c035c8238367063e2b270d51faa48c0f09e9d5b54746c360":
            # ref: https://hf-mirror.com/LumiOpen/Poro-34B-chat
            res = "poro-chat"
        if chkhsh == "7967bfa498ade6b757b064f31e964dddbb80f8f9a4d68d4ba7998fcf281c531a":
            # ref: https://hf-mirror.com/jinaai/jina-embeddings-v2-base-code
            res = "jina-v2-code"
        if chkhsh == "7fc505bd3104ca1083b150b17d088b59534ede9bde81f0dd2090967d7fe52cee":
            # ref: https://hf-mirror.com/LumiOpen/Viking-7B
            res = "viking"
        if chkhsh == "7b3e7548e4308f52a76e8229e4e6cc831195d0d1df43aed21ac6c93da05fec5f":
            # ref: https://hf-mirror.com/WisdomShell/CodeShell-7B
            res = "codeshell"
        if chkhsh == "855059429035d75a914d1eda9f10a876752e281a054a7a3d421ef0533e5b6249":
            # ref: https://hf-mirror.com/HuggingFaceTB/SmolLM-135M
            res = "smollm"
        if chkhsh == "3c30d3ad1d6b64202cd222813e7736c2db6e1bd6d67197090fc1211fbc612ae7":
            # ref: https://hf-mirror.com/bigscience/bloom
            res = "bloom"
        if chkhsh == "bc01ce58980e1db43859146dc51b1758b3b88729b217a74792e9f8d43e479d21":
            # ref: https://hf-mirror.com/TurkuNLP/gpt3-finnish-small
            res = "gpt3-finnish"
        if chkhsh == "fcace8b9cac38ce847670c970cd5892031a753a1ef381abd1d9af00f713da085":
            # ref: https://hf-mirror.com/microsoft/phi-2
            res = "phi-2"
        if chkhsh == "8b5a93ed704057481f240da0be7e7dca721d7f8f4755263b6807227a2cbeae65":
            # ref: https://hf-mirror.com/sentence-transformers/stsb-roberta-base
            res = "roberta-bpe"
        if chkhsh == "ad851be1dba641f2e3711822f816db2c265f788b37c63b4e1aeacb9ee92de8eb":
            # ref: https://hf-mirror.com/ai-sage/GigaChat-20B-A3B-instruct
            res = "gigachat"
        if chkhsh == "d4c8f286ea6b520b3d495c4455483cfa2302c0cfcd4be05d781b6a8a0a7cdaf1":
            # ref: https://hf-mirror.com/Infinigence/Megrez-3B-Instruct
            res = "megrez"
        if chkhsh == "877081d19cf6996e2c4ff0e1236341e9b7bde288f5311a56a937f0afbbb3aeb5":
            # ref: https://hf-mirror.com/deepseek-ai/DeepSeek-V3
            res = "deepseek-v3"
        if chkhsh == "b3f499bb4255f8ca19fccd664443283318f2fd2414d5e0b040fbdd0cc195d6c5":
            # ref: https://hf-mirror.com/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B
            res = "deepseek-r1-qwen"
        if chkhsh == "ccc2ef013c104be7bae2965776d611e1d7a8a2a9c547dd93a682c9a9fc80352e":
            # ref: https://hf-mirror.com/Xenova/gpt-4o
            res = "gpt-4o"
        if chkhsh == "7dec86086fcc38b66b7bc1575a160ae21cf705be7718b9d5598190d7c12db76f":
            # ref: https://hf-mirror.com/UW/OLMo2-8B-SuperBPE-t180k
            res = "superbpe"
        if chkhsh == "1994ffd01900cfb37395608534236ecd63f2bd5995d6cb1004dda1af50240f15":
            # ref: https://hf-mirror.com/trillionlabs/Trillion-7B-preview
            res = "trillion"
        if chkhsh == "96a5f08be6259352137b512d4157e333e21df7edd3fcd152990608735a65b224":
            # ref: https://hf-mirror.com/inclusionAI/Ling-lite
            res = "bailingmoe"
        if chkhsh == "0e9433cbbb161f89e264eb32e8e64bfe69e834973ffca5d41d3948a604a3e2a3":
            # ref: https://hf-mirror.com/mistral-community/pixtral-12b
            res = "pixtral"
        if chkhsh == "d5f1dd6f980fec569fb218a81a7658ac45fc56b38c5a0adeb1c232fbe04ef5ec":
            # ref: https://hf-mirror.com/ByteDance-Seed/Seed-Coder-8B-Base
            res = "seed-coder"
        if chkhsh == "55f6a8174f71aada214eff37005dda48ef023aba73bcc5336e38cb3073cfbd14":
            # ref: https://hf-mirror.com/wzmmmm/MixTex_finetune
            res = "mixtex"
    ...
    def set_gguf_parameters(self):
        ...
        if self.has_vision_encoder:
            ...
            self.gguf_writer.add_vision_head_count(
                self.find_vparam(["num_attention_heads", "n_head"])
            )
...
class LlavaVisionModel(MmprojModel):
    ...
    def modify_tensors(
        ...
        if name.startswith("multi_modal_projector.") or name.startswith(
            "vision_tower."
        ):
    ...
    def modify_tensors(
        ...
        if name.startswith("visual."):
            ...
            if ".qkv." in name:
                ...
                return [
                    (
                        gguf.TENSOR_NAMES[gguf.MODEL_TENSOR.V_ENC_EMBD_PATCH]
                        + ".weight",
                        data_torch[:, :, 0, ...],
                    ),
                    (
...
class InternVisionModel(MmprojModel):
    ...
    def modify_tensors(
        ...
        if name.startswith("vision_model") or name.startswith("mlp"):
            ...
            if (".ls" in name or "position_embedding" in name) and not name.endswith(
                ".weight"
            ):
                name += ".weight"
            # split QKV tensors if needed
            if ".qkv." in name:
                ...
                return [
                    (
                        self.map_tensor_name(
                            name.replace("attn.qkv", "self_attn.q_proj")
                        ),
                        wq,
                    ),
                    (
                        self.map_tensor_name(
                            name.replace("attn.qkv", "self_attn.k_proj")
                        ),
                        wk,
                    ),
                    (
                        self.map_tensor_name(
                            name.replace("attn.qkv", "self_attn.v_proj")
                        ),
                        wv,
                    ),
                ]
...
@ModelBase.register("GexTQwenForCausalLM")
class GexTQwenForCausalLM(Qwen2Model):
    model_arch = gguf.MODEL_ARCH.QWEN3
...
class GexTQwenVisionModel(MmprojModel):
    def __init__(self, *args, **kwargs):
        ...
        self.hparams_vision["hidden_size"] = self.hparams_vision.get("hidden_size", 16)
        self.hparams_vision["intermediate_size"] = self.hparams_vision.get(
        ...
        self.hparams_vision["num_hidden_layers"] = self.hparams_vision.get("depth", 12)
        if "embed_dim" in self.hparams_vision:  # qwen2vl
            self.hparams_vision["intermediate_size"] = self.hparams_vision.get(
                "hidden_size", 768
            )
            self.hparams_vision["hidden_size"] = self.hparams_vision.get(
                "embed_dim", 768
            )

    def set_gguf_parameters(self):
        print(self.hparams_vision)
        super().set_gguf_parameters()
        # print(f"add {self.find_vparam(['num_attention_heads', 'n_head'])}")
        # self.gguf_writer.add_vision_head_count(
        #     self.find_vparam(["num_attention_heads", "n_head"])
        # )
    ...
    def modify_tensors(
        ...
        # print(name)
        if name.startswith("model.vit.") or name.startswith("model.vit_proj."):
            print(name)
            name = name.replace("model.", "").replace("vit", "visual")
            ...
            elif "patch_embed.proj.weight" in name and len(data_torch.shape) == 5:
                print(name)
...
@ModelBase.register("VisionEncoderDecoderModel")
class MixTexGPT2Decoder(GPT2Model):
    model_arch = gguf.MODEL_ARCH.GPT2DEC

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.hparams = self.hparams["decoder"]
        self.hparams["n_ctx"] = 516
        # self.hparams["n_ctx"] = self.hparams["max_length"]
    ...
    def modify_tensors(
        ...
        if name.startswith("encoder"):
            return []
        # split QKV tensors if needed
        if ".c_attn." in name or ".q_attn." in name:
            print(f"attn:{name=}")
            if "crossattention" not in name:
                ...
                wv = data_torch[c * 2 :]
                return [
                    (self.map_tensor_name(name.replace("c_attn", "q")), wq),
                    (self.map_tensor_name(name.replace("c_attn", "k")), wk),
                    (self.map_tensor_name(name.replace("c_attn", "v")), wv),
                ]
            else:
                if "q_attn" in name:
                    if data_torch.ndim == 2:  # weight
                        wq = data_torch.transpose_(-1, -2)
                    else:  # bias
                        wq = data_torch
                    return [
                        (self.map_tensor_name(name.replace("q_attn", "q")), wq),
                    ]
                else:
                    if data_torch.ndim == 2:  # weight
                        data_torch = data_torch.transpose(-1, -2)
        ...
        if name.endswith((".c_proj.weight", ".c_fc.weight")):
            data_torch = data_torch.transpose(1, 0)
...
class CodeShellModel(TextModel):
    ...
    def modify_tensors(
        ...
        if not self._has_tok_embd and new_name == self.format_tensor_name(
            gguf.MODEL_TENSOR.OUTPUT
        ):
            ...
            if self.tensor_names and "transformer.wte.weight" in self.tensor_names:
                logger.debug(
                    f"{tok_embd_name} not found before {output_name}, assuming they are tied"
                )
    ...
    def modify_tensors(
        ...
        if "mlp.experts.mlp.w1" in name:
            data_torch = data_torch.view(
                self.hparams["num_experts"],
                self.hparams["n_inner"],
                self.hparams["n_embd"],
            )
            name += ".weight"
...
class Gemma3Model(TextModel):
    ...
    def set_gguf_parameters(self):
        ...
        self.gguf_writer.add_rope_freq_base(
            hparams.get("rope_theta", 1_000_000.0)
        )  # for global layers
...
class BailingMoeModel(TextModel):
    ...
    def set_gguf_parameters(self):
        ...
        hparams = self.hparams
        rope_dim = (
            hparams.get("head_dim")
            or hparams["hidden_size"] // hparams["num_attention_heads"]
        )
    ...
    def modify_tensors(
        ...
        if name.endswith("attention.dense.weight"):
            return [
                (self.format_tensor_name(gguf.MODEL_TENSOR.ATTN_OUT, bid), data_torch)
            ]
